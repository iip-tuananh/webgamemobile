...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    // Route::middleware('auth')->group(function () {
        ...
        Route::group(['prefix' => 'products', 'middleware' => 'checkType:'.User::KHACH_HANG], function () {
            Route::get('/get-list-products', 'Admin\ProductController@getListProducts')->name('products.getListProducts');
        });

        Route::group(['prefix' => 'ip-products'], function () {
            Route::get('/', 'Admin\IpProductController@index')->name('ip_products.index');
            Route::get('/searchData', 'Admin\IpProductController@searchData')->name('ip_products.searchData');
            Route::post('/', 'Admin\IpProductController@store')->name('ip_products.store');
            Route::get('/{id}/getDataForEdit', 'Admin\IpProductController@getDataForEdit')->name('ip_products.getDataForEdit');
            Route::get('/{id}/show', 'Admin\IpProductController@show')->name('ip_products.show');
            Route::post('/importExcel', 'Admin\IpProductController@importExcel')->name('ip_products.importExcel');
            Route::get('/renew-multi', 'Admin\IpProductController@renewMulti')->name('ip_products.renew.multi');
            Route::get('/exportPDF', 'Admin\IpProductController@exportPDF')->name('ip_products.exportPDF');
            Route::get('/{id}/delete', 'Admin\IpProductController@delete')->name('ip_products.delete');
            Route::post('/{id}/update', 'Admin\IpProductController@update')->name('ip_products.update');
        });
        ...
        Route::group(['prefix' => 'post-categories', 'middleware' => 'checkType:'.User::SUPER_ADMIN.','.User::QUAN_TRI_VIEN], function() {
            ...
            Route::get('/', 'Admin\PostCategoryController@index')->name('PostCategory.index')->middleware('checkPermission:Quản lý danh mục bài viết');
        ...
        // Bài viết
        Route::group(['prefix' => 'posts', 'middleware' => 'checkType:'.User::SUPER_ADMIN.','.User::QUAN_TRI_VIEN], function () {
            Route::get('/', 'Admin\PostController@index')->name('Post.index')->middleware('checkPermission:Quản lý bài viết');
            Route::get('/searchData', 'Admin\PostController@searchData')->name('Post.searchData')->middleware('checkPermission:Quản lý bài viết');
        ...
        // Danh mục đặc biệt
        Route::group(['prefix' => 'category-special', 'middleware' => 'checkType:'.User::SUPER_ADMIN.','.User::QUAN_TRI_VIEN], function () {
            Route::get('/', 'Admin\CategorySpecialController@index')->name('category_special.index')->middleware('checkPermission:Quản lý danh mục đặc biệt');
            Route::get('/searchData', 'Admin\CategorySpecialController@searchData')->name('category_special.searchData')->middleware('checkPermission:Quản lý danh mục đặc biệt');
        ...
        Route::group(['prefix' => 'orders'], function () {
            ...
            Route::get('/checkout', 'Admin\OrderController@checkout')->name('orders.checkout');
            ...
            Route::get('/delete-multi', 'Admin\OrderController@actDelete')->name('orders.delete.multi');
            Route::get('/cart', 'Admin\OrderController@cart')->name('orders.cart');
            Route::post('/storeCart', 'Admin\OrderController@storeCart')->name('orders.store.cart');
            Route::post('/payment/create', 'Admin\OrderController@createPayment')->name('orders.payment.create');
            Route::get('/payment/success', 'Admin\OrderController@handleSuccess')->name('orders.payment.success');
        });
        ...
        Route::group(['prefix' => 'common'], function () {
            ...
            Route::get('/dashboard-client', 'Common\DashboardController@indexClient')->name('dash-client');
            ...
            Route::group(['prefix' => 'roles', 'middleware' => 'checkType:'.User::SUPER_ADMIN.','.User::QUAN_TRI_VIEN], function () {
                ...
                Route::get('/{id}/edit', 'Common\RoleController@edit')->name('Role.edit')->middleware('checkPermission:Sửa chức vụ');
                Route::get('/{id}/delete', 'Common\RoleController@delete')->name('Role.delete')->middleware('checkPermission:Xóa chức vụ');
                Route::post('/{id}/update', 'Common\RoleController@update')->name('Role.update')->middleware('checkPermission:Sửa chức vụ');
                Route::get('/searchData', 'Common\RoleController@searchData')->name('Role.searchData')->middleware('checkPermission:Quản lý chức vụ');
            });

            Route::group(['prefix' => 'users', 'middleware' => 'checkType:'.User::SUPER_ADMIN.','.User::QUAN_TRI_VIEN], function () {
                Route::get('/create', 'Common\UserController@create')->name('User.create')->middleware('checkPermission:Thêm tài khoản');
                Route::post('/', 'Common\UserController@store')->name('User.store')->middleware('checkPermission:Thêm tài khoản');
                Route::get('/', 'Common\UserController@index')->name('User.index')->middleware('checkPermission:Quản lý tài khoản');
                Route::get('/{id}/edit', 'Common\UserController@edit')->name('User.edit')->middleware('checkPermission:Sửa tài khoản');
                Route::get('/{id}/delete', 'Common\UserController@delete')->name('User.delete')->middleware('checkPermission:Xóa tài khoản');
                Route::post('/{id}/update', 'Common\UserController@update')->name('User.update')->middleware('checkPermission:Sửa tài khoản');
                Route::get('/searchData', 'Common\UserController@searchData')->name('User.searchData')->middleware('checkPermission:Quản lý tài khoản');
            ...
            Route::group(['prefix' => 'users', 'middleware' => 'checkType:'.User::KHACH_HANG], function () {
            ...
            Route::group(['prefix' => 'tickets'], function () {
                ...
                Route::get('/create', 'Admin\TicketController@create')->name('Ticket.create');
                Route::get('/searchData', 'Admin\TicketController@searchData')->name('Ticket.searchData');
                Route::post('/', 'Admin\TicketController@store')->name('Ticket.store');
                Route::get('/{id}/show', 'Admin\TicketController@show')->name('Ticket.show');
                Route::post('/{id}/update', 'Admin\TicketController@update')->name('Ticket.update');
                Route::post('/update-status', 'Admin\TicketController@updateStatus')->name('Ticket.update.status');
            });
