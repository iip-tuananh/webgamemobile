...
class Product extends BaseModel
{
    ...
    public function ip_products()
    {
        return $this->hasMany(IpProduct::class, 'product_id', 'id');
    }

    public function getSpecificationAttribute()
    {
        return $this->cpu . ' CPU, ' . $this->ram . ' RAM, ' . $this->storage . ' Disk, ' . $this->band_width . ' Bandwidth';
    }

    public function getSellPriceAttribute()
    {
        if (Auth::check() && Auth::user()->upgrade_type == User::UPGRADE_TYPE_VIP) {
