...
<script>
    ...
    datatableInitComplete(self, saved_search) {
        return function () {
            ...
            html += `<a class="btn btn-primary mr-1" data-toggle="collapse" href="#collapseSearch${self.id}" role="button" aria-expanded="false" aria-controls="collapseSearch${self.id}"><i class="fa fa-sliders"></i> Bộ lọc</a>`;
            ...
            if (options.create_ticket_os) {
                html += `<a href="javascript:void(0)" title="" class="btn btn-warning act-create-ticket-os mr-1" ng-click="createTicketOsArr();"><i class="fa fa-tags"></i> Hỗ trợ OS</a>`;
            }
            if (options.renew) {
                html += `<a href="javascript:void(0)" title="" class="btn btn-success act-renew mr-1" onclick="renewArr();"><i class="fa fa-sync"></i> Gia hạn</a>`;
            }
            if (options.create_vps) {
                html += `<a href="${options.create_vps}" title="" class="btn btn-success mr-1"><i class="fa fa-plus"></i> Tạo VPS mới</a>`;
            }
            if (options.act) {
                html += `
                ...
                <div class="dropdown-menu">`;
                    ...
                    if (options.act.create_ticket) {
                        html += `<a href="javascript:void(0)" title="" class="dropdown-item act-create-ticket" ng-click="createTicketArr();"><i class="fa fa-tags"></i> Tạo ticket</a>`;
                    }
                    if (options.act.renew) {
                        html += `<a href="javascript:void(0)" title="" class="dropdown-item act-renew" onclick="renewArr();"><i class="fa fa-sync"></i>   Gia hạn</a>`;
                    }
                html += `</div>
                </button>`;
            }
