            ...
            <section class="section-pt">
                <div class="container">
                    ...
                    <div class="mt-40p" data-aos="fade-up">
                        <div class="four-card-two-column-carousel swiper" data-carousel-name="all-games-one"
                                ...
                                @foreach ($category->products as $product)
                                    <div class="swiper-slide">
                                        <div
                                            ...
                                            <a class="relative overflow-hidden rounded-12"
                            ...
                            <div class="swiper-pagination pagination-one all-games-one-carousel-pagination flex-c gap-2.5">
                            </div>
                        </div>
                    </div>
                    <style>
                        .four-card-two-column-carousel.swiper {
                            width: 100%;
                            height: 100%;
                            margin-left: auto;
                            margin-right: auto;
                        ...
                        .four-card-two-column-carousel.swiper .swiper-slide {
                    ...
                    <div class="container">
                        <div class="flex items-center justify-between flex-wrap gap-24p">
                            ...
                            <a href="{{ route('front.show-product-category', $category->slug) }}"
                                class="btn btn-lg py-3 btn-neutral-2 shrink-0">
                                Xem tất cả
                            </a>
                        </div>
                        <div class="mt-40p" data-aos="fade-up">
                                    ...
                                    @foreach ($category->products as $product)
                                        <div class="swiper-slide">
                                            <div class="w-full bg-b-neutral-3 rounded-12 group">
                                                <a class="overflow-hidden rounded-t-12"
                                                    href="{{ route('front.show-product-detail', $product->slug) }}">
                                                ...
                                                <div class="p-20p">
                                                    ...
                                                    <div class="flex-y flex-wrap justify-between gap-1">
                                                        <a href="{{ $product->short_link }}"
                                                            class="btn btn-xs rounded-12 btn-facebook w-40">
                                                            <i class="fab fa-facebook-f"></i>
                                                            Fanpage
                                                        </a>
                                                        <a href="{{ $product->aff_link }}"
                                                            class="btn btn-xs rounded-12 btn-zalo w-40">
                                                            <i class="fas fa-comments"></i>
                                                            Box Zalo
                                                        </a>
                                                        <a href="{{ $product->origin_link }}"
                                                            class="btn btn-xs btn-primary rounded-12 w-full">
                                                            <i class="fas fa-play"></i>
                                                            Chơi ngay
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="relative rounded-12 overflow-hidden w-full group">
                                            ...
                                            <div class="overlay-6 p-20p flex flex-col items-start justify-between">
                                                ...
                                                <div class="w-full">
                                                    ...
                                                    <span
                                                        class="text-l-regular text-w-neutral-2 mb-20p line-clamp-2">{{ $post->intro }}</span>
